...
def get_args(*args):
    ...
    parser.add_argument('--model_init_list', default='[1e-4, 1e-4]', type=str2list,
                        help='should be a list of the same size as model_hidden_list')
    parser.add_argument('--model_train_activation', default='relu',
                        help='options: relu, sigmoid, leakyrelu, tanh, gelu')
    ...
    parser.add_argument('--train_wd', default=0, type=float, help='actual value, not the exponent')
    parser.add_argument('--train_regression', default='false', type=str2bool, help='uses squared loss, +-1 labels')
    parser.add_argument('--train_huber_loss', default='false', type=str2bool, help='huber loss instead of square loss regression')
    ...
    parser.add_argument('--extraction_regression', default='false', type=str2bool, help='allow negative l, no use of y')
